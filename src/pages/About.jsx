        ...
        <div className="container px-6 py-12 mx-auto">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            <div className="sm:col-span-2">
              <h1 className="max-w-lg text-xl font-semibold tracking-tight text-gray-800 xl:text-2xl dark:text-white">Go to Gihub team</h1>
              ...
              <div className="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row">
                <input id="email" type="text" className="px-4 py-2 text-gray-700 bg-white border rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-blue-300" placeholder="Email Address" />
                  <a href="https://github.com/Natzgun/HydroSquad">
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex gap-4 hover:cursor-pointer">
              ...
              <a href="https://github.com/Natzgun/HydroSquad">
              <img src="https://www.svgrepo.com/show/94698/github.svg" className width={50} height={50} alt="gt" />
          ...
          <p className="font-sans p-8 text-start md:text-center md:text-lg md:p-4">© 2023 HydroSquad Inc. All rights reserved.</p>
        </div>
      </footer>
    </div >
  )
